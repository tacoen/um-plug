...
function um_toucher_html($div="",$js=0) {
		...
		?></select><button class='select-touch button' data-act='touch'>touch</button></p></div>
		...
		<div class="udtmd">
		<h4>Page-Template</h4>
		<p><input data-d='page-templates' type="text" name="udpt" /><button class='input-touch button' data-act='page-touch'>touch</button>
